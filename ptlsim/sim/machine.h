...
struct BaseMachine: public PTLsimMachine {
  ...
  void add_option(const char* name, const char* opt_name, bool value);
  void add_option(const char* name, const char* opt_name, int value);
  void add_option(const char* name, const char* opt_name, const char* value);
  void add_option(const char* core_name, int i, const char* opt_name, bool value);
  void add_option(const char* core_name, int i, const char* opt_name, int value);
  void add_option(const char* core_name, int i, const char* opt_name, const char* value);
